...
extern "C" {
     ...
     */
     MXS_API mxs_runtime::MXPODLayout *MXRegisterPODLayout(const char* name, const std::vector<mxs_runtime::MXPODLayout>& fields);

     /**
      * @brief Creates a non-owning MXPODObject that points to existing memory,
      * associating it with a specific layout.
      */
     MXS_API mxs_runtime::MXPODLayout *MXCreatePOD(void *source, const mxs_runtime::MXPODLayout* layout);
